...
public class GoalLogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goal_log);

        listview = (ListView) findViewById(R.id.goalLogListView);
    ...
    public void loadActivity() throws ExecutionException, InterruptedException {
        ...
        String result = backgroundWorker.execute("get_goal_log", username).get();
